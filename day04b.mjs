...
// console.log(boards);
// console.log(bingos);
const bingos2 = JSON.parse(JSON.stringify(bingos));

function sumUp(board, bingo) {
    // console.log('Summing up board:',board);
...
function checkBingo(board, bingo, i, j) {
    // const debug = (board[0][0] === 3);
    // Check row
    const row = bingo[i];
    // if (debug) {
    ...
    if (!row.includes(false)) {
        // Bingo!
        // if (debug) { console.log('Bingo row:', i); }
        return true;
    }
    // for (let x = 0; x < 5; x++) {
    //     if (bingo[i][x] === false) {
    ...
    // if (debug) {
    //     console.log('Checking column:', j, col);
    // }
    if (!col.includes(false)) {
        // Bingo!
        // if (debug) { console.log('Bingo col:', j); }
        return true;
    }
    // for (let y = 0; y < 5; y++) {
    //     if (bingo[y][j] === false) {
...
function puzzle1() {
    ...
    for (const ball of balls) {
        ...
        for (let b = 0; b < boards.length; b++) {
            ...
            const bingo = bingos[b];
            for (let i = 0; i < 5; i++) {
                for (let j = 0; j < 5; j++) {
                    if (board[i][j] === ball) {
                        bingo[i][j] = true;
                        // CHECK BINGO
                        if (checkBingo(board, bingo, i, j)) {
                            return sumUp(board, bingo) * ball;
                        }
                    }
                }
            }
...
function puzzle2() {
                ...
                for (let j = 0; j < 5; j++) {
                    if (board[i][j] === ball) {
                        ...
                        if (checkBingo(board, bingo, i, j)) {
                            ...
                            winners.push(boards.splice(b, 1)[0]);
                            bwinners.push(bingos2.splice(b, 1)[0]);
                            ballers.push(ball);
                            // console.log('Winners:',winners, bwinners, ballers);
                            b--;
                        }
                    }
                }
    ...
    // console.log('Final Bingo:', finalBingo);
    // console.log('Final Ball:', finalBall);
    return sumUp(finalWinner, finalBingo) * ballers[lastPlace];
}
